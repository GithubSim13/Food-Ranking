...
client/src/
  ...
  components/
    ...
    home/
      HomePage.tsx         # / — dashboard root; assembles all sections; 248 lines
      HomeShared.tsx       # shared Card wrapper and layout primitives used across home sub-components
      ...
      LoggingPaceCard.tsx  # Logging Pace bar chart; peak month highlight; streak subtitle
      BestValueCard.tsx    # Best Value Spot split card; highest avg rating2 restaurant; entry list on right
    entries/
