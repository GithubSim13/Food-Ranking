...
- [x] Best of the Month — Reigning Champion card replaced with Best of the Month; highest-rated entry with a review.date in the current calendar month; falls back to all-time highest-rated if no current-month entries; no longer restricted to starred entries; gold styling preserved if winning entry is starred
